"use strict";
(self["webpackChunkregistry"] = self["webpackChunkregistry"] || []).push([["polyfills"],{
...
function compileDeclareClassMetadata(metadata) {
  ...
  definitionMap.set('version', literal('14.2.6'));
...
function createDirectiveDefinitionMap(meta) {
  ...
  definitionMap.set('version', literal('14.2.6')); // e.g. `type: MyDirective`
